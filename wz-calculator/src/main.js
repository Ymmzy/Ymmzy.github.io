...
export function main(mainCharacter) {
    ...
    document.querySelector("#shopGrid").innerHTML = '';
    document.querySelector("#runeGrid").innerHTML = '';
    document.querySelector("#heroGrid-sub-1").innerHTML = '';
    ...
    const eftGridDiv = document.querySelector('#shopGrid');
    ...
    const eftHeaderContainer = document.querySelector('#shopGrid .ag-header-container');
    ...
    const charEftGridDiv = document.querySelector('#runeGrid');
    ...
    const subGridDiv = [document.querySelector("#heroGrid-sub-1"), document.querySelector("#SubGrid-2")];
